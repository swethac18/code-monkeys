...
public class Status {
  ...
  public boolean getPossiblySensitive() { return this.possibly_sensitive; }

  public void setPossiblySensitive(boolean possibly_sensitive) { this.possibly_sensitive = possibly_sensitive; }
